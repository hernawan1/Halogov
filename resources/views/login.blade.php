...
<head>
  ...
  <title>Administrator TP4D</title>
...
<body class="hold-transition login-page" style="background:#ececec;">
<div class="login-box">
  <div class="login-logo">
    <img src="../images/logo-kejaksaan.png" width="150">
  </div>
  <!-- /.login-logo -->
    ...
    <form action="aksi.php" method="post">
      ...
      <div class="form-group has-feedback">
        ...
        <div class="social-auth-links text-center">
           <div class="g-recaptcha" data-sitekey="6LehU70UAAAAABnepXTBZxuz-yN_AmHs5q8p8onO"></div>
        </div>
      <div class="row">
        <div class="col-xs-8">
