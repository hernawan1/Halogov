...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <div align="right">
                <button class="btn btn-md btn-success" data-toggle="modal" data-target="#modalTambahs"
            ...
            <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php
                        $x=1;
                    ?>
                    @foreach($data_kemudaan as $kemudaan)
                    <tr>
                        <td><?=$x?></td>
                        <td>{{$kemudaan->nama}}</td>
                        <td>{{$kemudaan->ketua}}</td>
                        <td>{{$kemudaan->pendiri}}</td>
                        <td>{{$kemudaan->alamat}}</td>
                        <td>{{$kemudaan->status}}</td>
                        <td>
                            <button class="btn btn-success" style="padding:3px 6px;" data-toggle="modal"
                                data-target="#modalEditkemudaan{{$kemudaan->id}}"><i class="fa fa-edit"></i></button>
                            <button class="btn btn-danger" style="padding:3px 6px;" data-toggle="modal"
                                data-target="#modalHapusKemudaan"><i class="fa fa-trash-o"></i></button>
                        </td>
                        <div id="modalEditkemudaan{{$kemudaan->id}}" class="modal fade" role="dialog" aria-labelledby="exampleModalCenterTitle"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('editormas', ['id'=>$kemudaan->id])}}" method="post" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            <div class="box-body">
                        ...
                        <div id="modalHapusKemudaan" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-footer">
                                        <a href="{{route('hapusormas', ['id'=>$kemudaan->id])}}"><button type="button" name="ok_button"
        ...
        <div id="modalTambahs" class="modal fade" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
