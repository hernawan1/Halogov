...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <div align="right">
                <button class="btn btn-md btn-success" data-toggle="modal" data-target="#modalprofesi"
            ...
            <table id="example" class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php
                        $x=1;
                    ?>
                    @foreach($data_profesi as $profesi)
                    <tr>
                        <td><?=$x?></td>
                        <td>{{$profesi->nama}}</td>
                        <td>{{$profesi->ketua}}</td>
                        <td>{{$profesi->pendiri}}</td>
                        <td>{{$profesi->alamat}}</td>
                        <td>{{$profesi->status}}</td>
                        <td>
        ...
        <div id="modalprofesi" class="modal fade" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{route('addormas')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <input type="hidden" name="kategori" value="profesi">
                            </div>
                            <!-- /.box-body -->
