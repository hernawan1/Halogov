                    ...
                    <div class="box-body ">
                        <div align="right">
                            <button class="btn btn-md btn-success" data-toggle="modal" data-target="#modalTambah"
                                style="padding:6px 6px; margin:0px 0px 10px 0px;">Tambah Video</button></div>
                        ...
                        <table id="example" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><iframe style="width:50%;" src="<?php echo $ubah;?>" frameborder="0"
                                    ...
                                    <td>
                                        <button class="btn btn-danger" style="padding:3px 6px;" data-toggle="modal"
                                            data-target="#exampleModal{{$d->id}}"><i class="fa fa-trash-o"></i></button>
                                    </td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <a href="hapusvideo/{{$d->id}}"><button type="button"
                                                            name="ok_button"
