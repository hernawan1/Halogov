...
<head>
    ...
    <link rel="stylesheet" href="{{asset('includes/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')}}">
...
<body class="hold-transition skin-green sidebar-mini" style="width:93%;margin:0px auto;background: url(../resources/boxed-bg.jpg) repeat fixed;box-shadow: 0 10px 20px rgba(0,0,0,0.35), 0 6px 6px rgba(0,0,0,0.23);">
<div class="wrapper">
...
<script>
 CKEDITOR.disableAutoInline = true;
    ...
    CKEDITOR.replace('editor1', {
      ...
      filebrowserBrowseUrl: '{{asset('includes/kcfinder/browse.php?type=files')}}',
      filebrowserImageBrowseUrl: '{{asset('includes/kcfinder/browse.php?type=images')}}',
      filebrowserUploadUrl: '{{asset('includes/kcfinder/upload.php?type=files')}}',
      filebrowserImageUploadUrl: '{{asset('includes/kcfinder/upload.php?type=images')}}',
      filebrowserFlashBrowseUrl : '{{asset('includes/kcfinder/browse.php?type=flash')}}',
      filebrowserFlashUploadUrl : '{{asset('includes/kcfinder/upload.php?type=flash')}}',
